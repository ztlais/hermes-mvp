...
# Clean up any old drafts from this session
for old_id in ['r-3632475238113181342', 'r3940876531373913584', 'r4936094277981261891']:
    try:
...
print(f"\n✅ Draft vierge créé — Gmail → Brouillons")
